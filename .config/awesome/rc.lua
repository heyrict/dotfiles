...
globalkeys = gears.table.join(globalkeys,
    awful.key({}, "Print", function()
        awful.util.spawn("scrot ~/Pictures/Screenshot%Y-%m-%dT%H:%M:%S.png && notify-send -u low -c system 'Screenshot saved successfully'", false)
    end),
    awful.key({"Shift", }, "Print", function()
        awful.util.spawn("scrot -s ~/Pictures/Screenshot%Y-%m-%dT%H:%M:%S.png && notify-send -u low -c system 'Screenshot saved successfully'", false)
    end),
    awful.key({"Control", }, "Print", function()
        awful.util.spawn("scrot -bu ~/Pictures/Screenshot%Y-%m-%dT%H:%M:%S.png && notify-send -u low -c system 'Screenshot saved successfully'", false)
    end)
)
