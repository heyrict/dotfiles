...
our $SCHEMA = [
    ...
    #         COMMAND                                                     LABEL                     ICON
    {item => ["alacritty",                                                "Open Terminal",          "$ENV{HOME}/.icons/gladient/term.png"]},
    {item => ["firefox",                                                  "Firefox",                "firefox"]},
    {item => ["nnn",                                                      "Open File Manager",      "$ENV{HOME}/.icons/gladient/file-manager.png"]},
    {item => ["wemeet-x11",                                               "Wemeet",                 "wemeetapp"]},
    {sep  => undef},
    ...
    {item => ["alacritty -e ~/.config/openbox/visual-mode/wally",         "Change Wallpaper",       "$ENV{HOME}/.icons/gladient/wally.png"]},
    {item => ["~/.config/openbox/visual-mode/termody",                    "Reverse Terminal Visual","$ENV{HOME}/.icons/gladient/term.png"]},
    {sep  => undef},
    {item => ["alacritty -e ~/.config/openbox/visual-mode/ob-button",     "Change Button Style",    "$ENV{HOME}/.icons/gladient/obt-c.png"]},
